...
export const BackOfficeResidentDetail: React.FC<Props> = ({ resident, onBack, onAddIpEvent, onEditIpEvent, onAddAbtEvent, onEditAbtEvent }) => {
  const { store } = useFacilityData();
  const { updateDB } = useDatabase();
  const [activeTab, setActiveTab] = useState<'ip' | 'abx'>('ip');
