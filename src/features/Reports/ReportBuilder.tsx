...
const AVAILABLE_COLUMNS: ColumnDef[] = [
  ...
  { id: 'res_sex',       label: 'Sex',              fieldPath: 'resident.sex' },
  { id: 'res_unit',      label: 'Unit',             fieldPath: 'resident.location.unit' },
  { id: 'res_room',      label: 'Room',             fieldPath: 'resident.location.room' },
  ...
  { id: 'res_status',    label: 'Resident Status',  fieldPath: 'resident.status' },
  { id: 'res_payor',     label: 'Payor',            fieldPath: 'resident.payor' },
  { id: 'res_diagnosis', label: 'Primary Diagnosis',fieldPath: 'resident.primaryDiagnosisText' },
  { id: 'res_cognitive', label: 'Cognitive Status', fieldPath: 'resident.cognitiveStatus' },

  // ── Clinical Device Fields ───────────────────────────────────────────
  { id: 'dev_oxygen', label: 'Oxygen', fieldPath: 'resident.clinicalDevices.oxygen.enabled' },
  { id: 'dev_oxygen_mode', label: 'Oxygen Mode', fieldPath: 'resident.clinicalDevices.oxygen.mode' },
  { id: 'dev_ucath', label: 'Urinary Catheter', fieldPath: 'resident.clinicalDevices.urinaryCatheter.active' },
  { id: 'dev_ucath_date', label: 'Urinary Catheter Inserted', fieldPath: 'resident.clinicalDevices.urinaryCatheter.insertedDate' },
  { id: 'dev_icath', label: 'Indwelling Catheter', fieldPath: 'resident.clinicalDevices.indwellingCatheter.active' },
  { id: 'dev_icath_date', label: 'Indwelling Catheter Inserted', fieldPath: 'resident.clinicalDevices.indwellingCatheter.insertedDate' },
  { id: 'dev_midline', label: 'Midline', fieldPath: 'resident.clinicalDevices.midline.active' },
  { id: 'dev_midline_date', label: 'Midline Inserted', fieldPath: 'resident.clinicalDevices.midline.insertedDate' },
  { id: 'dev_picc', label: 'PICC', fieldPath: 'resident.clinicalDevices.picc.active' },
  { id: 'dev_picc_date', label: 'PICC Inserted', fieldPath: 'resident.clinicalDevices.picc.insertedDate' },
  { id: 'dev_piv', label: 'PIV', fieldPath: 'resident.clinicalDevices.piv.active' },
  { id: 'dev_piv_date', label: 'PIV Inserted', fieldPath: 'resident.clinicalDevices.piv.insertedDate' },
  { id: 'dev_cline', label: 'Central Line', fieldPath: 'resident.clinicalDevices.centralLine.active' },
  { id: 'dev_cline_date', label: 'Central Line Inserted', fieldPath: 'resident.clinicalDevices.centralLine.insertedDate' },
  { id: 'dev_trach', label: 'Trach', fieldPath: 'resident.clinicalDevices.trach.active' },
  { id: 'dev_trach_date', label: 'Trach Inserted', fieldPath: 'resident.clinicalDevices.trach.insertedDate' },
  { id: 'dev_peg', label: 'PEG Tube', fieldPath: 'resident.clinicalDevices.peg.active' },
  { id: 'dev_peg_date', label: 'PEG Tube Inserted', fieldPath: 'resident.clinicalDevices.peg.insertedDate' },
  { id: 'dev_woundvac', label: 'Wound Vac', fieldPath: 'resident.clinicalDevices.woundVac.active' },
  { id: 'dev_woundvac_date', label: 'Wound Vac Inserted', fieldPath: 'resident.clinicalDevices.woundVac.insertedDate' },
  { id: 'dev_dialysis', label: 'Dialysis Access', fieldPath: 'resident.clinicalDevices.dialysisAccess.active' },
  { id: 'dev_dialysis_date', label: 'Dialysis Access Inserted', fieldPath: 'resident.clinicalDevices.dialysisAccess.insertedDate' },
  { id: 'dev_ostomy', label: 'Ostomy', fieldPath: 'resident.clinicalDevices.ostomy.active' },

  // ── ABT (Antibiotic) Fields ───────────────────────────────────────────
  { id: 'abt_med',          label: 'ABT Medication',         fieldPath: 'abt.medication' },
  { id: 'abt_class',        label: 'ABT Class',              fieldPath: 'abt.medicationClass' },
  { id: 'abt_dose',         label: 'Dose',                   fieldPath: 'abt.dose' },
  { id: 'abt_dose_unit',    label: 'Dose Unit',              fieldPath: 'abt.doseUnit' },
  { id: 'abt_route',        label: 'Route',                  fieldPath: 'abt.route' },
  { id: 'abt_frequency',    label: 'Frequency',              fieldPath: 'abt.frequency' },
  ...
  { id: 'abt_inf_source',   label: 'ABT Infection Source',   fieldPath: 'abt.infectionSource' },
  { id: 'abt_broad',        label: 'Broad Spectrum',         fieldPath: 'abt.isBroadSpectrum' },
  ...
  { id: 'abt_culture_src',  label: 'Culture Source',         fieldPath: 'abt.cultureSource' },
  { id: 'abt_organism',     label: 'Organism Identified',    fieldPath: 'abt.organismIdentified' },
  { id: 'abt_sensitivity',  label: 'Sensitivity Summary',    fieldPath: 'abt.sensitivitySummary' },
  { id: 'abt_prescriber',   label: 'Prescriber',             fieldPath: 'abt.prescriber' },
  { id: 'abt_timeout',      label: 'Timeout Review Date',    fieldPath: 'abt.timeoutReviewDate' },

  // ── IP (Infection Prevention) Fields ─────────────────────────────────
  ...
  { id: 'ip_source',        label: 'Source of Infection',    fieldPath: 'ip.sourceOfInfection' },
  { id: 'ip_protocol',      label: 'Protocol Type',          fieldPath: 'ip.protocolType' },
  { id: 'ip_status',        label: 'IP Status',              fieldPath: 'ip.status' },
  { id: 'ip_date',          label: 'IP Onset Date',          fieldPath: 'ip.onsetDate' },
  { id: 'ip_specimen_date', label: 'Specimen Collected Date',fieldPath: 'ip.specimenCollectedDate' },
  { id: 'ip_lab_date',      label: 'Lab Result Date',        fieldPath: 'ip.labResultDate' },
  ...
  { id: 'ip_nhsn_cauti',    label: 'NHSN CAUTI Met',         fieldPath: 'ip.nhsnCautiMet' },
  { id: 'ip_nhsn_cdiff',    label: 'NHSN C. diff LabID Met', fieldPath: 'ip.nhsnCdiffLabIdMet' },

  // ── Vaccination Fields ────────────────────────────────────────────────
  { id: 'vax_name',     label: 'Vaccine',            fieldPath: 'vax.vaccine' },
  { id: 'vax_status',   label: 'Vax Status',         fieldPath: 'vax.status' },
  { id: 'vax_date',     label: 'Date Given',          fieldPath: 'vax.canonicalDate' },
  { id: 'vax_dose',     label: 'Dose Number',         fieldPath: 'vax.dose' },
  { id: 'vax_lot',      label: 'Lot Number',          fieldPath: 'vax.lotNumber' },
  { id: 'vax_admin_by', label: 'Administered By',     fieldPath: 'vax.administeredBy' },
  { id: 'vax_site',     label: 'Administration Site', fieldPath: 'vax.administrationSite' },
  { id: 'vax_decline',  label: 'Decline Reason',      fieldPath: 'vax.declineReason' },
  { id: 'vax_due',      label: 'Due Date',             fieldPath: 'vax.dueDate' },
  { id: 'vax_offer',    label: 'Offer Date',           fieldPath: 'vax.offerDate' },
];
