...
const SECTIONS: { key: keyof ResidentCoursePDFConfig; label: string; description: string }[] = [
  ...
  { key: 'includeClinicalNarrative', label: 'SNF/LTC Course / Clinical Narrative', description: 'Prose summary of the SNF/LTC course: infections, treatments, and current status' },
  ...
  { key: 'includeRecommendations', label: 'Plan of Care Continuity', description: 'Active treatment continuation, current precautions to maintain, and reassessment focus' },
];
