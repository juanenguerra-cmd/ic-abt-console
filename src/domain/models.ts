...
export interface ShiftLogEntry {
  ...
  /** true when entry was created from a Resident Board hashtag trigger */
  autoGenerated?: boolean;
  /** the raw hashtag string value that triggered the auto-entry, e.g. 'Isolation', 'Outbreak', 'Symptomatic' */
